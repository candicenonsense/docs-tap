...
#### <a id='1-6-4-lsp-ki'></a> v1.6.4 Known issues: Local Source Proxy

- If you try to install Local Source Proxy outside of a Tanzu Application Platform profile that
  includes it, and the `SecurityContextConstraits` policy is missing, installation fails at the
  OpenShift distribution stage.
